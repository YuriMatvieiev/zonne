...
// Додайте обробник кліків до документа
document.addEventListener("click", function (e) {
  const menu = document.querySelector(".menu__body");

  // Перевірка, чи клік відбувся поза меню та поза кнопкою icon-menu
  if (!menu.contains(e.target) && !e.target.classList.contains("icon-menu")) {
